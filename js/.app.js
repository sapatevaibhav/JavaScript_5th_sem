    ...
    html += `
            <div class="taskCard my-2 mx-2 card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <button id="${index}"onclick="deletetask(this.id)" class="btn btn-primary">Delete this task</button>
                    </div>
                </div>`;
  });
...
let butn=document.getElementById('searchTxtBtn');
butn.addEventListener('click',function(eve){
    eve.preventDefault();
})
